...
export const MessengerContextChat: React.FC<ContextChatProps> = ({ context, contactId, onClose }) => {
  const { t } = useLanguage();
    ...
    <div className="context-chat">
      ...
      <div className="context-chat-body">
        {contextMessages.length === 0 ? (
          <div className="context-chat-empty">{t('messenger_empty')}</div>
        ) : (
...
export default MessengerContextChat;
